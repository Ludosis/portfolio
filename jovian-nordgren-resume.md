...
Embedded across multiple Tech Art and content teams on Unreal Engine 5 and Lego Fortnite, owning pipeline integrity and quality across FX, animation, content optimization, world/terrain, and procedural content. Served as animation domain liaison, coordinating test coverage, communicating risk, and keeping distributed QA teams in sync across a large-scale live project.
...
- Built an automation triage tool with Claude Code in a single day, integrating APIs and MCPs to generate an HTML report with cross-platform comparison, trend tracking, and Jira-linked failure notes
...
- Built a debug config tool that triggered public event completion conditions on demand at any reward tier, enabling reward and audio bucket testing that had been too time-consuming to run manually; the audio team adopted it independently, and the dev who built the event system hadn't known the debug trigger existed
...
- Led a mid-production strike team to re-evaluate scope; helped transition to a collaborative department-leads structure that stabilized a large team that had been struggling with unified direction
...
*Animation Instructor — Project FUN (Summer 2013 & 2014)*
Taught traditional and digital animation workflows to students at varied skill levels; managed team operations and production deadlines.

---

## Skills

**Real-Time & Rendering:** VFX, shader authoring, lighting, rendering, performance optimization
**3D Art:** Modeling (low/high poly), sculpting, UV unwrap, texturing, rigging, skinning
**Animation:** Traditional, 2D, 3D, tech animation support
**Tools & Pipeline:** Asset auditing, LOD validation, pipeline tooling, workflow documentation, Perforce, Git
**Scripting:** Python, C#, Lua
**AI & Automation:** Claude Code, LLM-assisted development and tooling, Midjourney, API/MCP integration
**Software:** Unreal Engine, Unity 3D, ZBrush, Maya, 3DS Max, Photoshop, Illustrator, After Effects, Premiere, InDesign, Substance Designer & Painter, Visual Studio
